    ...
    <section id="contacto" className="contact-section">
      <div className="contact-content">
        ...
        >
          ...
          <span>
            {t("contact.whatsappUs")} <strong>+34 694 91 70 83</strong>
          </span>
        </a>
        ...
        >
          <p>
            📞 <strong style={{ color: "#25d366" }}>+34 694 91 70 83</strong>
          </p>
          <p style={{ marginTop: "0.5rem" }}>
            ✉️{" "}
            <a
              href="mailto:automatismolaprovincia@gmail.com"
              style={{ color: "#25d366", textDecoration: "none" }}
            >
              automatismolaprovincia@gmail.com
            </a>
          </p>
        </div>
        ...
        <div style={{ marginTop: "2rem" }}>
          ...
          <div className="hero-actions" style={{ gap: "0.75rem" }}>
            ...
            >
              <svg width="36" height="36" viewBox="0 0 24 24" fill="var(--color-accent)">
